...
class PDBFile
{
	public:
		...
		// Action methods
		PDBFileState load_pdb_file(const wchar_t*filename);
		DWORD64 PeGetImportThunkDataRaw(LPCSTR dll_name, LPCSTR func_name);
		PDBFileState load_image_file(const wchar_t* filename);
